CLASS zcl_sto_step_billing DEFINITION
  PUBLIC
...
CLASS zcl_sto_step_billing IMPLEMENTATION.

  METHOD constructor.
    super->constructor( ).
    mv_step_name = zif_sto_process_step=>gc_step_name-billing.
  ENDMETHOD.
...
*      APPEND VALUE #( process_item    = <ls_item>-process_item
*                      document_number = lv_po
*                      document_item   = <ls_item>-process_item
*                      quantity        = <ls_item>-quantity
*                      base_unit       = <ls_item>-base_unit
